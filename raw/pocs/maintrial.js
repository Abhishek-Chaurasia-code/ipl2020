...
function creatorFile(playerName,teamName,venue,date,runs,balls,fours,sixes,sr,result,opponent){
   ...
   /* else if(fs.existsSync(pathOfFile)==true){
       ...
       // let content = data.toString();
        ...
        fs.appendFileSync(pathOfFile,JSON.stringify(json)); 
    } */
   /*  else{
        fs.readFile(pathOfFile,function (err,data){
           ...
           fs.writeFile(pathOfFile,JSON.stringify(json));
